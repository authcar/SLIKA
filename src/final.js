document.addEventListener("DOMContentLoaded", () => {
  ...
  const FRAME_DESIGNS_BY_LAYOUT = {
    layout2: [
      ...
      { label: "Chocolate Mint", src: "./src/assets/frames/2/frame-mint.png" },
      { label: "Star", src: "./src/assets/frames/2/frame-purplestar.png" },
      { label: "Red Polka", src: "./src/assets/frames/2/frame-red-polka.png" },
      { label: "Aero", src: "./src/assets/frames/2/frame-blue.png" },
      { label: "Pink Polka", src: "./src/assets/frames/2/frame-pink-polka.png" },
      { label: "Gingham", src: "./src/assets/frames/2/frame-gingham.png" },
      { label: "Ice Cream", src: "./src/assets/frames/2/frame-icecream.png" },
    ],
    layout3: [
      ...
      { label: "Red Polka", src: "./src/assets/frames/3/frame-floral.png" },
      { label: "Aero", src: "./src/assets/frames/3/frame-blue.png" },
      ...
      { label: "Pink Polka", src: "./src/assets/frames/3/frame-polka.png" },
    ...
    layout4: [
      ...
      { label: "Denim", src: "./src/assets/frames/4/frame-denim.png" },
      { label: "Star", src: "./src/assets/frames/4/frame-star.png" },
      { label: "Red Polka", src: "./src/assets/frames/4/frame-red-polka.png" },
      { label: "Pink Polka", src: "./src/assets/frames/4/frame-pink-polka.png" },
      { label: "Gingham", src: "./src/assets/frames/4/frame-gingham.png" },
      { label: "Ice Cream", src: "./src/assets/frames/4/frame-cream.png" },
      { label: "Grass", src: "./src/assets/frames/4/frame-grass.png" },],
  };
